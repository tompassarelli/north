# Custom shader boundaries

## Decisions and rationale

Custom shaders do not automatically preserve built-in lighting or output conversion. ShaderMaterial supplies common declarations; RawShaderMaterial needs explicit declarations, while the renderer can still supply recognized matrix values. Use the shader skill for coordinate-space and version-sensitive extension details.
