# Render state, maps, and shared ownership

## Decisions and rationale

Transparency affects sorting and depth; disabling depth writes is a tradeoff, not a universal fix. Geometry groups select material-array entries. Cloned materials can still share textures, so material disposal is not ownership of every referenced map. Uniform-like edits usually do not need recompilation.
