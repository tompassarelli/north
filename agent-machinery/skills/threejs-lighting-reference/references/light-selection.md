# Light selection and staging

## Decisions and rationale

Light intensity, exposure, units, and material response form one appearance system. Example intensities are starting points, not calibrated physical claims. Directional and spot targets need scene/world updates. Area lights provide highlights for supported PBR materials but are not general shadow-casting lights.
