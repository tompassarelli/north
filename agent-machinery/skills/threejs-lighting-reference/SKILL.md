...
description: >-
  Detailed procedures, examples, and tables for Three.js lighting - light types, shadows, environment lighting. Use when adding lights, configuring shadows, setting up IBL, or optimizing lighting performance. Use after
  threejs-lighting-distilled when exact API patterns or specialist detail are required.
---

# Three.js Lighting Reference
