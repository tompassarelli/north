...
description: >-
  Detailed procedures, examples, and tables for Three.js textures - texture types, UV mapping, environment maps, texture settings. Use when working with images, UV coordinates, cubemaps, HDR environments, or texture optimization. Use after
  threejs-textures-distilled when exact API patterns or specialist detail are required.
---

# Three.js Textures Reference
