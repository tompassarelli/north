...
description: >-
  Detailed procedures, examples, and tables for Three.js post-processing - EffectComposer, bloom, DOF, screen effects. Use when adding visual effects, color grading, blur, glow, or creating custom screen-space shaders. Use after
  threejs-postprocessing-distilled when exact API patterns or specialist detail are required.
---

# Three.js Post-Processing Reference
