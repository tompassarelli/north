---
name: threejs-fundamentals-reference
description: >-
  Detailed procedures, examples, and tables for Three.js scene setup, cameras, renderer, Object3D hierarchy, coordinate systems. Use when setting up 3D scenes, creating cameras, configuring renderers, managing object hierarchies, or working with transforms. Use after
  threejs-fundamentals-distilled when exact API patterns or specialist detail are required.
---

# Three.js Fundamentals Reference

Read the distilled sibling first. Use this unit only for the detailed section needed by the current task.
