# Effect math and patterns

## Decisions and rationale

A Fresnel or rim dot product needs both operands in the same space. Displaced positions may need changed normals and bounds; a visually plausible displacement does not update either automatically. Noise and branchless forms are tools to measure, not inherently faster alternatives.
