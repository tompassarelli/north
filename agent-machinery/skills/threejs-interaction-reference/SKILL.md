...
description: >-
  Detailed procedures, examples, and tables for Three.js interaction - raycasting, controls, mouse/touch input, object selection. Use when handling user input, implementing click detection, adding camera controls, or creating interactive 3D experiences. Use after
  threejs-interaction-distilled when exact API patterns or specialist detail are required.
---

# Three.js Interaction Reference
