...
description: >-
  Detailed procedures, examples, and tables for Three.js animation - keyframe animation, skeletal animation, morph targets, animation mixing. Use when animating objects, playing GLTF animations, creating procedural motion, or blending animations. Use after
  threejs-animation-distilled when exact API patterns or specialist detail are required.
---
