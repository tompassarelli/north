...
(def audited-run-single
  #{"agent" "agent_run_ledger_version" "allocation_mode" "applied_bespoke_contract_sha256"
    ...
    "compaction_policy_version" "delivery_outcome" "delivery_reason" "duration_ms"
    "estimate_hours" "estimate_delta_ms" "estimate_ratio" "estimate_classification"
    "provider_duration_ms" "effort"
    ...
    "graph_text_experiment_reason" "graph_text_experiment_assignment_sha256"
    ...
    "effective_authoring_hooks" "authoring_authority_surface"
    "authoring_authority_surface_coverage" "effective_authority_provider" "effective_live_input"
