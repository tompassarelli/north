...
(def VOCAB
  [;; --- executable schema meta-predicates (the schema describes itself) ---
   ...
   ["composition_kind" "single" "literal" "managed Orchestration composition kind (preset|bespoke); absent on native sessions"]
   ["composition_id" "single" "literal" "Orchestration preset or bespoke composition id"]
   ...
   ["composition_override" "multi" "literal" "one Orchestration preset axis overridden for a run"]
