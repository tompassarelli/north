...
(def CORE-ENTITY-KINDS
  (sorted-map
   ...
   "notification" "A durable attention event addressed to one stable principal."
   ...
   "subscription" "A durable observer registration over one thread and semantic event filter."
