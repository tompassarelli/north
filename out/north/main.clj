...
(defn cmd-cockpit [^String log]
  ...
  (println "CONTROL")
  (println "  north  — select a live row, type a message, or use /interrupt")
  (println "  north app attach <execution-id> [--cursor N]")
  (println "  north app msg <execution-id> <message> · north app interrupt <execution-id>")))
