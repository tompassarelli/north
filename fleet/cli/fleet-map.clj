;; fleet-map.clj — deterministic FAN-OUT + BARRIER (Lodestar fleet primitive 4). Sibling to
;; presence-cli/msg-cli/lease-cli; speaks the SAME daemon wire (:assert / :version / :query /
;; :resolved). This is the capability the fleet lacked vs an Anthropic Workflow: spawn N workers
