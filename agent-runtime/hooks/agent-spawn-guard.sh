...
machinery_root = os.environ.get("AGENT_MACHINERY_HOME")
if not machinery_root:
    machinery_root = os.path.expanduser("~/code/agent-machinery/main")
ORCHESTRATION_AGENTS = os.path.join(machinery_root, "agents")
