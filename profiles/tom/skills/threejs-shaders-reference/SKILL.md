...
description: >-
  Detailed procedures, examples, and tables for Three.js shaders - GLSL, ShaderMaterial, uniforms, custom effects. Use when creating custom visual effects, modifying vertices, writing fragment shaders, or extending built-in materials. Use after
  threejs-shaders-distilled when exact API patterns or specialist detail are required.
---

# Three.js Shaders Reference
