...
description: >-
  Detailed procedures, examples, and tables for Three.js asset loading - GLTF, textures, images, models, async patterns. Use when loading 3D models, textures, HDR environments, or managing loading progress. Use after
  threejs-loaders-distilled when exact API patterns or specialist detail are required.
---

# Three.js Loaders Reference
