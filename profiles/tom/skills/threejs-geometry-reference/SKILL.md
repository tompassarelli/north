...
description: >-
  Detailed procedures, examples, and tables for Three.js geometry creation - built-in shapes, BufferGeometry, custom geometry, instancing. Use when creating 3D shapes, working with vertices, building custom meshes, or optimizing with instanced rendering. Use after
  threejs-geometry-distilled when exact API patterns or specialist detail are required.
---

# Three.js Geometry Reference
