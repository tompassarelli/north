# Verification doctrine — reconciliation record (provenance)

Split from `verification-doctrine.md` §7 on 2026-07-30: the doctrine file
keeps the laws; this file keeps the archaeology — how each law was earned.
New refinements append here, dated; when one changes a law, edit the law in
the doctrine and record the why here.
