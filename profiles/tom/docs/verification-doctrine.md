...
**Status:** opt-in reference. Use only when the user's current request
explicitly asks for assurance or verification. It is never ordinary task-intake
policy. Provenance: `verification-doctrine-provenance.md`.
