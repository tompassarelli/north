# Comms — universal output norms (role-independent)

The comms axis is separate from role: role sets WHAT the deliverable is and
its format; comms sets the register every report uses regardless of role.
Roles carry their own REPORT format; this block is composed into every
agent in addition to it.
