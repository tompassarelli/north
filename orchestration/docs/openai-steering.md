...
|---|---|---|---|---|
| 1 | Scope under pressure | Bounded jobs inflate into assurance/certification programs; adjacent problems displace the requested one | mining: 5 scope-inflation incidents, 3 severe ("bounded landing job into an open-ended assurance program"); harness 01: rebuilt subscriber admission already bounded by `BEAGLE_STORE_CONNECTION_WORKERS` | family §3, §4 |
