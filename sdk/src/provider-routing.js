...
const headroom = pressure((((_truthy) => _truthy !== false && _truthy != null)(policy.targetPressures) ? (() => { return $$bh$aget(policy.targetPressures, target.id); })() : null));
...
function select_route(requested, states, policy, axes, stable_key, model, capabilities) {
  ...
  const target_pressure = pressure((((_truthy) => _truthy !== false && _truthy != null)(policy.targetPressures) ? (() => { return $$bh$aget(policy.targetPressures, target.id); })() : null));
  ...
  (($beagle$host$arg$0, $beagle$host$arg$1, $beagle$host$arg$2) => $$bh$aset($$bh$admit_host_object($beagle$host$arg$0), $beagle$host$arg$1, $beagle$host$arg$2))(target_pressures, target.id, pressure((((_truthy) => _truthy !== false && _truthy != null)(policy.targetPressures) ? (() => { return $$bh$aget(policy.targetPressures, target.id); })() : null)));
});
