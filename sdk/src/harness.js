...
function ambient_child_environment_bang() {
  return remove_ambient_keys_bang(Object.assign({}, process.env), ["NORTH_DISPATCH_DRIVER_PRECLAIMED", "NORTH_RUN_ID", "NORTH_THREAD_ID", "NORTH_RUN_CAPABILITY", "NORTH_RUN_ARTIFACT_DIR", "NORTH_MANAGED_LANE", "NORTH_ORCHESTRATION_ROLE", "NORTH_CODEX_BIN", "NORTH_BIN", "AGENT_MODEL", "AGENT_PROJECT_PROFILE", "AGENT_REASONING", "AGENT_CAPABILITY_FLOOR", "AGENT_SERVICE_CLASS"]);
}
...
function north_mcp_environment(child, options) {
  const source = Object.assign({}, child, {[$$bc$property_key($$bc$keyword("NORTH_BIN"))]: ENGINE});
