...
async function refreshOne(
  ...
  try {
    return await withFileLease(lockPath, async () => {
      ...
      try {
        ...
        try {
          ...
          return unavailableReport(account, failedObservation, "usage_observation_store_unavailable", false);
        }
        return unavailableReport(account, failedObservation, reason, false);
      }
    ...
    return unavailableReport(account, fallback, "usage_observation_store_unavailable", false);
  }
}
