...
import {
  "clear-panel-filter!" as clearPanelFilter,
  "config-detail-lines!" as configDetailLines,
  "config-fold-rows" as configFoldRows,
  "config-node-expanded?" as configNodeExpanded,
  "config-panel-legend" as configPanelLegend,
  "config-panel-rows" as configPanelRows,
  "config-query-field" as configQueryField,
  "config-query-rows" as configQueryRows,
  "config-reference-text" as configReferenceText,
  "config-row-context-only?" as configRowContextOnly,
  "config-row-matches?" as configRowMatches,
  ...
  "filter-character" as filterCharacter,
  "filter-key-action" as filterKeyAction,
  "fold-key-action" as foldKeyAction,
  "active-focus" as activeFocus,
  "config-kind-tag" as configKindTag,
  "tab-action" as tabAction,
  "tab-fold-step!" as tabFoldStep,
  "tab-swap-view" as tabSwapView,
  "help-query-rows" as helpQueryRows,
  "render-detail-panel!" as renderDetailPanel,
  "set-node-expanded!" as setNodeExpanded,
  "set-panel-query!" as setPanelQuery,
